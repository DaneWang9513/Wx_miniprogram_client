...
Page({
  ...
  getConnectToDB: function() {
    ...
    wx.request({
      ...
      url: getApp().globalData.urlpath +'/getSignin',
      method: 'POST',
      data: {
        FormerID: getApp().globalData.username + getApp().globalData.first_name
      },
      //header: {
       // "Content-Type": "application/x-www-form-urlencoded"
      //},
      success: function (res) {
        ...
        for(var i = 0; i < list.length; i++) {
          ...
          var nowtime = nowYear + '/' + nowMonth + '/' + nowDay +' '+nowHours + ':' + nowMin + ':' + nowSeconds;
          //判断是否结束
